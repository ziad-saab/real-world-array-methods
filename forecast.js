...
function willRain(arr) {
	return arr.some(function(currentHour) {
		return currentHour.precipType; // Chance of rain isn't really a boolean, but this feels less arbitrary than currentHour.precipType > "notable percentage"
	});
}

// console.log(willRain(weatherData.hourly.data));
...
function willRainHours(arr, hours) {
	return arr.filter(function(currentHour, index) {
			return index < hours;
	})
	.some(function(currentHour) {
		return currentHour.precipType;
	});
}

// console.log(willRainHours(weatherData.hourly.data, 8));
...
function getTemperatures(arr) {
	return arr.map(function(currentHour) {
		return currentHour.temperature;
	});
}

// console.log(getTemperatures(weatherData.hourly.data));
...
// Using a chain of two array methods, start with the hourly data and return an array of Date objects saying when it will rain.

// Eliminate any item where it is not raining.
// Extract the time from the remaining items and create a Date object

function getRainTimes(arr) {
	return arr.filter(function(currentHour) {
		return currentHour.precipType;
	})
	.map(function(currentRainyHourObj) {
		return new Date(currentRainyHourObj.time*1000);
	});
}

// console.log(getRainTimes(weatherData.hourly.data));

// This would also be possible with arr.reduce()

// OUTPUT:

// [ Sat Jul 09 2016 03:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 04:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 05:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 06:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 07:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 08:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 09:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 10:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 11:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 12:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 13:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 14:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 15:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 16:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 17:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 18:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 19:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 20:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 21:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 22:00:00 GMT+0000 (UTC),
//   Sat Jul 09 2016 23:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 00:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 01:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 02:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 03:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 04:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 05:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 06:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 07:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 08:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 09:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 10:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 11:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 12:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 13:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 14:00:00 GMT+0000 (UTC),
//   Sun Jul 10 2016 15:00:00 GMT+0000 (UTC) ]
...
function willBeSunny(arr) {
    return arr.some(function(day) {
        return day.summary.toLowerCase().indexOf("sun") != -1; // Only return true if any day summary *doesn't* contain false
    });
}

// console.log(willBeSunny(weatherData.daily.data))
...
function peakTemperature(arr) {
    return getTemperatures(arr)
    .reduce(function(prevHottest, currHottest) {
        if (currHottest > prevHottest) {
            prevHottest = currHottest;
        }
        return prevHottest;
    }, -Infinity);
}

// console.log(peakTemperature(weatherData.hourly.data));

// OUTPUT:

// 81.44

// Using the appropriate array method, start with the daily data and find out how many times each icon appears.

function dayWeatherCount(arr) {
    return arr.reduce(function(weekSoFar, currentDay, index) {
        weekSoFar[currentDay.icon] ? weekSoFar[currentDay.icon]++ : weekSoFar[currentDay.icon] = 1;
        return weekSoFar;
    }, {});
}

// console.log(dayWeatherCount(weatherData.daily.data));

// OUTPUT:

// { rain: 5, 'partly-cloudy-day': 3 }
...
// Keep only the unique cities in the list (hint: this is NOT filter)
...
function raidBoss(arr) {
    return arr.filter(function(objToInspect) {
        return objToInspect.email.toLowerCase().indexOf("biz") != -1;
    })
    .map(function(bizEmailObj) {
        return bizEmailObj.address.city
    })
    .reduce(function(uniqueCities, currentCity) {
        if (uniqueCities.indexOf(currentCity) == -1) {
