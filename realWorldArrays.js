...
// need to access indexes of data array with in the hourly object.
// 


function rainCheck(obj){
   
    var rainString = obj.hourly.summary.toLowerCase().split(" ");
     return rainString.some(function(item){return item === "rain";})
    
};
console.log(rainCheck(weather))


// ## Is it going to rain part 2
// Using a chain of two array methods, figure out if it's going to rain in the next
// // 8 hours. To do this, you'll have to start with the hourly data and:
// 1. Eliminate any item where the time is further than 8 hours from now.
// // 2. Do the same thing as part 1.

function rainCheck2(obj){
   
    var rainEightHours = obj.hourly.data.slice(0,8);
    return rainEightHours.some(function(item){
        return item.summary.toLowerCase().match('rain')
         }); 
}
console.log(rainCheck2(weather));


// ## Just give me the temperature
// Using the appropriate array method, start with the hourly data and return an 
// array of **only** the temperatures. Your returned array should have the same 
